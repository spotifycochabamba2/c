...
struct Storyboard {
  ...
  static let IntroToInstagram = "IntroToInstagram"
  
  static let IntroToHome = "IntroToHome"
  
  static let LoginToHome = "LoginToHome"
  static let SignupToHome = "SignupToHome"
  static let SignupToInstagram = "SignupToInstagram"
  static let LoginToInstagram = "LoginToInstagram"
  
  static let HomeToMyGarden = "HomeToMyGarden"
  static let HomeToProducesWanted = "HomeToProducesWanted"
  
  static let MyGardenToAddProduce = "MyGardenToAddProduce"
  static let MyGardenToCamera = "MyGardenToCamera"
  
  static let AddProduceToCamera = "AddProduceToCamera"
  static let AddProduceToCameraRetake = "AddProduceToCameraRetake"
  
  static let CameraRetakeToCamera = "CameraRetakeToCamera"
  static let CameraToCameraConfirm = "CameraToCameraConfirm"
  
  static let HomeToProduceDetail = "HomeToProduceDetail"
  
  
  
  // new design
  static let FeedToProduce = "FeedToProduce"
  static let GardenToAddProduce = "GardenToAddProduce"
  static let AddProduceChildToCamera = "AddProduceChildToCamera"
